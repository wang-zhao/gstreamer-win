...
#ifdef PNG_STDIO_SUPPORTED
/* Initialize the input/output for the PNG file to the default functions. */
PNG_EXPORT(235, void, png_init_io_ex, (png_structp png_ptr, png_FILE_p fp, png_voidp file_open, png_voidp file_close, png_voidp file_read, png_voidp file_write));
#endif
