 ...
 */
__declspec(dllimport) extern gpointer _SOUP_METHOD_OPTIONS;
__declspec(dllimport) gpointer _SOUP_METHOD_GET;
__declspec(dllimport) extern gpointer _SOUP_METHOD_HEAD;
__declspec(dllimport) extern gpointer _SOUP_METHOD_POST;
__declspec(dllimport) extern gpointer _SOUP_METHOD_PUT;
__declspec(dllimport) extern gpointer _SOUP_METHOD_DELETE;
__declspec(dllimport) extern gpointer _SOUP_METHOD_TRACE;
__declspec(dllimport) extern gpointer _SOUP_METHOD_CONNECT;

__declspec(dllimport) extern gpointer _SOUP_METHOD_PROPFIND;
__declspec(dllimport) extern gpointer _SOUP_METHOD_PROPPATCH;
__declspec(dllimport) extern gpointer _SOUP_METHOD_MKCOL;
__declspec(dllimport) extern gpointer _SOUP_METHOD_COPY;
__declspec(dllimport) extern gpointer _SOUP_METHOD_MOVE;
__declspec(dllimport) extern gpointer _SOUP_METHOD_LOCK;
__declspec(dllimport) extern gpointer _SOUP_METHOD_UNLOCK;
