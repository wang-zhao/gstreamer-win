...
/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkaboutdialog.h" */
GType gtk_license_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_LICENSE (gtk_license_get_type ())

/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkaccelgroup.h" */
GType gtk_accel_flags_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_ACCEL_FLAGS (gtk_accel_flags_get_type ())

/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkapplication.h" */
...
/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkassistant.h" */
...
/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkbuilder.h" */
GType gtk_builder_error_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_BUILDER_ERROR (gtk_builder_error_get_type ())

/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkcalendar.h" */
...
/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkcellrenderer.h" */
...
/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkcellrendereraccel.h" */
...
/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkcssprovider.h" */
...
/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkcsssection.h" */
GType gtk_css_section_type_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_CSS_SECTION_TYPE (gtk_css_section_type_get_type ())

/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkdebug.h" */
GType gtk_debug_flag_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_DEBUG_FLAG (gtk_debug_flag_get_type ())

/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkdialog.h" */
...
/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkdnd.h" */
...
/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkentry.h" */
...
/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkenums.h" */
...
GType gtk_level_bar_mode_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_LEVEL_BAR_MODE (gtk_level_bar_mode_get_type ())
GType gtk_input_purpose_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_INPUT_PURPOSE (gtk_input_purpose_get_type ())
GType gtk_input_hints_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_INPUT_HINTS (gtk_input_hints_get_type ())

/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkfilechooser.h" */
...
/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkfilefilter.h" */
GType gtk_file_filter_flags_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_FILE_FILTER_FLAGS (gtk_file_filter_flags_get_type ())

/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkicontheme.h" */
...
/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkiconview.h" */
...
/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkimage.h" */
GType gtk_image_type_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_IMAGE_TYPE (gtk_image_type_get_type ())

/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkmessagedialog.h" */
GType gtk_buttons_type_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_BUTTONS_TYPE (gtk_buttons_type_get_type ())

/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtknotebook.h" */
GType gtk_notebook_tab_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_NOTEBOOK_TAB (gtk_notebook_tab_get_type ())

/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkprintoperation.h" */
...
/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkrecentchooser.h" */
...
/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkrecentfilter.h" */
...
/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkrecentmanager.h" */
...
/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtksizegroup.h" */
GType gtk_size_group_mode_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_SIZE_GROUP_MODE (gtk_size_group_mode_get_type ())

/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkspinbutton.h" */
...
/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtktextbuffer.h" */
...
/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtktextiter.h" */
GType gtk_text_search_flags_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_TEXT_SEARCH_FLAGS (gtk_text_search_flags_get_type ())

/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtktextview.h" */
GType gtk_text_window_type_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_TEXT_WINDOW_TYPE (gtk_text_window_type_get_type ())

/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtktoolbar.h" */
...
/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtktoolpalette.h" */
...
/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtktreemodel.h" */
GType gtk_tree_model_flags_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_TREE_MODEL_FLAGS (gtk_tree_model_flags_get_type ())

/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtktreeview.h" */
...
/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtktreeviewcolumn.h" */
...
/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkuimanager.h" */
...
/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/gtkwidget.h" */
GType gtk_widget_help_type_get_type (void) G_GNUC_CONST;
#define GTK_TYPE_WIDGET_HELP_TYPE (gtk_widget_help_type_get_type ())

/* enumerations from "/E/Workspace/EaseTele/EaseTeleAVSolution/GStreamer/Main/gtk/gtk/deprecated/gtkrc.h" */
