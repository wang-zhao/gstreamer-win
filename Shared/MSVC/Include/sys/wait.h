...
//   (((union { __typeof(__status) _in_; int _out_; }) { (__status) })._out_))

static int __wait_status_to_int (int __status)
{ return __status; }
// static int __wait_status_to_int (const union wait  __status)
// { return __status.w_status; }
