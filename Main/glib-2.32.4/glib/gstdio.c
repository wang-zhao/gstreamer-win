...
{
	return _ungetc_nolock(Ch, stream);
}
...
ssize_t g_fread(void * _DstBuf, ssize_t _ElementSize, ssize_t _Count, FILE * _File)
{
...
size_t  g_fwrite(const void * _Str, ssize_t _Size, ssize_t _Count, FILE * _File)
{
...
{
	return ungetc(_Ch, _File);
}
int  g_pclose(FILE * _File)
{
	return _pclose(_File);
}
...
{
	setbuf(_File, _Buffer);
}
int  g_setvbuf(FILE * _File, gchar * _Buf, int _Mode, ssize_t _Size)
{
	return setvbuf(_File, _Buf, _Mode, _Size);
}
FILE *  g_tmpfile(void)
{
	return tmpfile();
...
int  g_fprintf_p(FILE * _File, const gchar * _Format, ...)
{
	int nret;
	va_list vars;
	va_start(vars, _Format);

	nret = _vfprintf_p(_File, _Format, vars);
	return nret;
}
...
{
	return _fclose_nolock(_File);
}
int  g_fflush_nolock(FILE * _File)
{
	return _fflush_nolock(_File);
}
size_t  g_fread_nolock(void * _DstBuf, ssize_t _ElementSize, ssize_t _Count, FILE * _File)
{
	return _fread_nolock(_DstBuf, _ElementSize, _Count, _File);
}
size_t  g_fread_nolock_s(void * _DstBuf, ssize_t _DstSize, ssize_t _ElementSize, ssize_t _Count, FILE * _File)
{
	return _fread_nolock_s( _DstBuf, _DstSize, _ElementSize, _Count, _File);
}
int  g_fseek_nolock(FILE * _File, long _Offset, int _Origin)
{
	return _fseek_nolock(_File, _Offset, _Origin);
}
long  g_ftell_nolock(FILE * _File)
{
	return _ftell_nolock(_File);
}
int  g_fseeki64_nolock(FILE * _File, gint64 _Offset, int _Origin)
{
	return _fseeki64_nolock(_File, _Offset, _Origin);
}
gint64  g_ftelli64_nolock(FILE * _File)
{
	return _ftelli64_nolock(_File);
}
size_t  g_fwrite_nolock(const void * _DstBuf, ssize_t _Size, ssize_t _Count, FILE * _File)
{
	return _fwrite_nolock(_DstBuf, _Size, _Count, _File);
}
int  g_ungetc_nolock(int _Ch, FILE * _File)
{
	return _ungetc_nolock(_Ch, _File);
}
FILE* g_stdout()
{
	return stdout;
...
{
  return _lseeki64(fd, offset, ori);
}
gint64 g_tell64(_In_ int _FileHandle)
{
  return _telli64(_FileHandle);
}
...
{
	return _stati64(_Name, _Stat);
}
int g_fstati64(int _FileDes, void* _Stat)
{
	return _fstati64(_FileDes, _Stat);
}
int g_fstat(int _Desc, void* _Stat)
{
	return fstat(_Desc, _Stat);
}
