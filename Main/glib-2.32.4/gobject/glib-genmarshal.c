...
{
  g_fputs ("\n", fout);
  g_fputs ("#ifdef G_ENABLE_DEBUG\n", fout);
  g_fputs ("#define g_marshal_value_peek_boolean(v)  g_value_get_boolean (v)\n", fout);
  g_fputs ("#define g_marshal_value_peek_char(v)     g_value_get_schar (v)\n", fout);
  g_fputs ("#define g_marshal_value_peek_uchar(v)    g_value_get_uchar (v)\n", fout);
  g_fputs ("#define g_marshal_value_peek_int(v)      g_value_get_int (v)\n", fout);
  g_fputs ("#define g_marshal_value_peek_uint(v)     g_value_get_uint (v)\n", fout);
  g_fputs ("#define g_marshal_value_peek_long(v)     g_value_get_long (v)\n", fout);
  g_fputs ("#define g_marshal_value_peek_ulong(v)    g_value_get_ulong (v)\n", fout);
  g_fputs ("#define g_marshal_value_peek_int64(v)    g_value_get_int64 (v)\n", fout);
  g_fputs ("#define g_marshal_value_peek_uint64(v)   g_value_get_uint64 (v)\n", fout);
  g_fputs ("#define g_marshal_value_peek_enum(v)     g_value_get_enum (v)\n", fout);
  g_fputs ("#define g_marshal_value_peek_flags(v)    g_value_get_flags (v)\n", fout);
  g_fputs ("#define g_marshal_value_peek_float(v)    g_value_get_float (v)\n", fout);
  g_fputs ("#define g_marshal_value_peek_double(v)   g_value_get_double (v)\n", fout);
  g_fputs ("#define g_marshal_value_peek_string(v)   (char*) g_value_get_string (v)\n", fout);
  g_fputs ("#define g_marshal_value_peek_param(v)    g_value_get_param (v)\n", fout);
  g_fputs ("#define g_marshal_value_peek_boxed(v)    g_value_get_boxed (v)\n", fout);
  g_fputs ("#define g_marshal_value_peek_pointer(v)  g_value_get_pointer (v)\n", fout);
  g_fputs ("#define g_marshal_value_peek_object(v)   g_value_get_object (v)\n", fout);
  g_fputs ("#define g_marshal_value_peek_variant(v)  g_value_get_variant (v)\n", fout);
  g_fputs ("#else /* !G_ENABLE_DEBUG */\n", fout);
  g_fputs ("/* WARNING: This code accesses GValues directly, which is UNSUPPORTED API.\n", fout);
  g_fputs (" *          Do not access GValues directly in your code. Instead, use the\n", fout);
  g_fputs (" *          g_value_get_*() functions\n", fout);
  g_fputs (" */\n", fout);
  g_fputs ("#define g_marshal_value_peek_boolean(v)  (v)->data[0].v_int\n", fout);
  g_fputs ("#define g_marshal_value_peek_char(v)     (v)->data[0].v_int\n", fout);
  g_fputs ("#define g_marshal_value_peek_uchar(v)    (v)->data[0].v_uint\n", fout);
  g_fputs ("#define g_marshal_value_peek_int(v)      (v)->data[0].v_int\n", fout);
  g_fputs ("#define g_marshal_value_peek_uint(v)     (v)->data[0].v_uint\n", fout);
  g_fputs ("#define g_marshal_value_peek_long(v)     (v)->data[0].v_long\n", fout);
  g_fputs ("#define g_marshal_value_peek_ulong(v)    (v)->data[0].v_ulong\n", fout);
  g_fputs ("#define g_marshal_value_peek_int64(v)    (v)->data[0].v_int64\n", fout);
  g_fputs ("#define g_marshal_value_peek_uint64(v)   (v)->data[0].v_uint64\n", fout);
  g_fputs ("#define g_marshal_value_peek_enum(v)     (v)->data[0].v_long\n", fout);
  g_fputs ("#define g_marshal_value_peek_flags(v)    (v)->data[0].v_ulong\n", fout);
  g_fputs ("#define g_marshal_value_peek_float(v)    (v)->data[0].v_float\n", fout);
  g_fputs ("#define g_marshal_value_peek_double(v)   (v)->data[0].v_double\n", fout);
  g_fputs ("#define g_marshal_value_peek_string(v)   (v)->data[0].v_pointer\n", fout);
  g_fputs ("#define g_marshal_value_peek_param(v)    (v)->data[0].v_pointer\n", fout);
  g_fputs ("#define g_marshal_value_peek_boxed(v)    (v)->data[0].v_pointer\n", fout);
  g_fputs ("#define g_marshal_value_peek_pointer(v)  (v)->data[0].v_pointer\n", fout);
  g_fputs ("#define g_marshal_value_peek_object(v)   (v)->data[0].v_pointer\n", fout);
  g_fputs ("#define g_marshal_value_peek_variant(v)  (v)->data[0].v_pointer\n", fout);
  g_fputs ("#endif /* !G_ENABLE_DEBUG */\n", fout);
  g_fputs ("\n", fout);
}
