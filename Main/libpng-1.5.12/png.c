...
void PNGAPI
png_init_io_ex(png_structp png_ptr, png_FILE_p fp, png_voidp file_open, png_voidp file_close, png_voidp file_read, png_voidp file_write)
{
	if( png_ptr == 0 )
		return ;
	...
	png_ptr->file_close = file_close;
	png_ptr->file_open = file_open;
	png_ptr->file_read = file_read;
	png_ptr->file_write = file_write;
}
