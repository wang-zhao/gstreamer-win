...
draw_pattern (cairo_surface_t **surface_inout, int surface_size)
{
	...
	cairo_surface_write_to_png(*surface_inout, "output\\1.png");
	...
	cairo_surface_write_to_png(*surface_inout, "output\\2.png");
	...
	cairo_surface_write_to_png(*surface_inout, "output\\3.png");
	...
	cairo_surface_write_to_png(*surface_inout, "output\\4.png");
	...
	cairo_surface_write_to_png(*surface_inout, "output\\5.png");
	...
	cairo_surface_write_to_png(*surface_inout, "output\\6.png");
	...
	cairo_surface_write_to_png(*surface_inout, "output\\7.png");
	...
	cairo_surface_write_to_png(*surface_inout, "output\\8.png");
	...
	cairo_surface_write_to_png(*surface_inout, "output\\9.png");
