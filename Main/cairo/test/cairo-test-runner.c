...
_runner_fini (cairo_test_runner_t *runner)
{
    ...
    xfree (runner->crashes_per_target);
    xfree (runner->errors_per_target);
    xfree (runner->fails_per_target);

    xfree (runner->num_crashed_per_target);
    xfree (runner->num_error_per_target);
    xfree (runner->num_failed_per_target);
