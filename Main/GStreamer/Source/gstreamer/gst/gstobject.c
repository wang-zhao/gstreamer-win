...
/**
 * gst_object_get_ancestor:
 * @object: a #GstObject to find ancestor
 *
 * MT safe. Grabs and releases @object's locks.
 */
GstObject*
gst_object_get_ancestor (GstObject * object )
{
  GstObject *parent, *tmp;
  ...
  tmp = gst_object_ref(object);
  while(tmp) 
  {
    parent = gst_object_get_parent (tmp);
    if( parent )
    {  
