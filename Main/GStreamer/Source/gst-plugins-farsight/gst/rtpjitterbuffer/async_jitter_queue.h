...
guint32       async_jitter_queue_get_underruns      (AsyncJitterQueue *queue);

gfloat        async_jitter_queue_get_high_threshold (AsyncJitterQueue *queue);
gfloat        async_jitter_queue_get_low_threshold  (AsyncJitterQueue *queue);
...
gpointer      async_jitter_queue_pop_unlocked_forced (AsyncJitterQueue * queue);
...
void          async_jitter_queue_set_blocking_unlocked   (AsyncJitterQueue* queue,
                                                          gboolean blocking);
guint32       async_jitter_queue_length_ts_units_unlocked (AsyncJitterQueue *queue);

void          async_jitter_queue_flush_unlocked (AsyncJitterQueue * queue,
                                                 GFunc free_func,
                                                 gpointer user_data);
