...
/* autogenerated from E:\Build\OSSBuild\Main\GStreamer\Windows\.\..\Source\gst-plugins-good\gst\videomixer\blendorc.orc */
...
#ifdef DISABLE_ORC
void
orc_memcpy_u32 (guint32 * ORC_RESTRICT d1, const guint32 * ORC_RESTRICT s1, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
...
#ifdef DISABLE_ORC
void
orc_blend_u8 (guint8 * ORC_RESTRICT d1, int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int p1, int n, int m){
  int i;
  int j;
...
#ifdef DISABLE_ORC
void
orc_blend_argb (guint8 * ORC_RESTRICT d1, int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int p1, int n, int m){
  int i;
  int j;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
  ...
  for (j = 0; j < m; j++) {
    ...
    for (i = 0; i < n; i++) {
      ...
      var43 = var42.i;
      /* 3: splatbl */
      var44.i = ((var43&0xff) << 24) | ((var43&0xff)<<16) | ((var43&0xff) << 8) | (var43&0xff);
      /* 4: convubw */
...
#ifdef DISABLE_ORC
void
orc_blend_bgra (guint8 * ORC_RESTRICT d1, int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int p1, int n, int m){
  int i;
  int j;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
  ...
  for (j = 0; j < m; j++) {
    ...
    for (i = 0; i < n; i++) {
      ...
      var45 = var44.i;
      /* 4: splatbl */
      var46.i = ((var45&0xff) << 24) | ((var45&0xff)<<16) | ((var45&0xff) << 8) | (var45&0xff);
      /* 5: convubw */
...
#ifdef DISABLE_ORC
void
orc_overlay_argb (guint8 * ORC_RESTRICT d1, int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int p1, int n, int m){
  int i;
  int j;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
  ...
  for (j = 0; j < m; j++) {
    ...
    for (i = 0; i < n; i++) {
      ...
      var46 = var45.i;
      /* 3: splatbl */
      var47.i = ((var46&0xff) << 24) | ((var46&0xff)<<16) | ((var46&0xff) << 8) | (var46&0xff);
      /* 4: convubw */
      ...
      var58 = var57.i;
      /* 16: splatbl */
      var59.i = ((var58&0xff) << 24) | ((var58&0xff)<<16) | ((var58&0xff) << 8) | (var58&0xff);
      /* 17: convubw */
...
#ifdef DISABLE_ORC
void
orc_overlay_bgra (guint8 * ORC_RESTRICT d1, int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int p1, int n, int m){
  int i;
  int j;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
  ...
  for (j = 0; j < m; j++) {
    ...
    for (i = 0; i < n; i++) {
      ...
      var48 = var47.i;
      /* 4: splatbl */
      var49.i = ((var48&0xff) << 24) | ((var48&0xff)<<16) | ((var48&0xff) << 8) | (var48&0xff);
      /* 5: convubw */
      var50.x4[0] = (orc_uint8)var49.x4[0];
      var50.x4[1] = (orc_uint8)var49.x4[1];
      var50.x4[2] = (orc_uint8)var49.x4[2];
      ...
      var61 = var60.i;
      /* 18: splatbl */
      var62.i = ((var61&0xff) << 24) | ((var61&0xff)<<16) | ((var61&0xff) << 8) | (var61&0xff);
      /* 19: convubw */
