                                 ...
                                 gpointer      marshal_data)
{
  ...
  callback = (GMarshalFunc_BOXED__UINT) (marshal_data ? marshal_data : cc->callback);
                                            ...
                                            gpointer      marshal_data)
{
  ...
  callback = (GMarshalFunc_UINT64__BOOLEAN_UINT64) (marshal_data ? marshal_data : cc->callback);
