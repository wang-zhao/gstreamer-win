...
void
_fs_marshal_VOID__OBJECT_ENUM_STRING_STRING (GClosure     *closure,
...
{
  typedef void (*GMarshalFunc_VOID__OBJECT_ENUM_STRING_STRING) (gpointer     data1,
                                                                gpointer     arg_1,
                                                                gint         arg_2,
                                                                gpointer     arg_3,
                                                                gpointer     arg_4,
                                                                gpointer     data2);
  register GMarshalFunc_VOID__OBJECT_ENUM_STRING_STRING callback;
  ...
  callback = (GMarshalFunc_VOID__OBJECT_ENUM_STRING_STRING) (marshal_data ? marshal_data : cc->callback);
...
void
_fs_marshal_VOID__ENUM_STRING_STRING (GClosure     *closure,
                                      GValue       *return_value G_GNUC_UNUSED,
                                      guint         n_param_values,
                                      const GValue *param_values,
                                      gpointer      invocation_hint G_GNUC_UNUSED,
...
/* VOID:BOXED,BOXED */
void
_fs_marshal_VOID__BOXED_BOXED (GClosure     *closure,
                               GValue       *return_value G_GNUC_UNUSED,
                               guint         n_param_values,
                               const GValue *param_values,
                               gpointer      invocation_hint G_GNUC_UNUSED,
...
/* VOID:OBJECT,OBJECT */
void
_fs_marshal_VOID__OBJECT_OBJECT (GClosure     *closure,
                                 GValue       *return_value G_GNUC_UNUSED,
                                 guint         n_param_values,
                                 const GValue *param_values,
                                 gpointer      invocation_hint G_GNUC_UNUSED,
...
/* VOID:UINT,ENUM */
void
_fs_marshal_VOID__UINT_ENUM (GClosure     *closure,
                             GValue       *return_value G_GNUC_UNUSED,
                             guint         n_param_values,
                             const GValue *param_values,
                             gpointer      invocation_hint G_GNUC_UNUSED,
                             gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__UINT_ENUM) (gpointer     data1,
                                                guint        arg_1,
                                                gint         arg_2,
                                                gpointer     data2);
...
/* OBJECT:UINT */
void
_fs_marshal_OBJECT__UINT (GClosure     *closure,
                          GValue       *return_value G_GNUC_UNUSED,
                          guint         n_param_values,
                          const GValue *param_values,
                          gpointer      invocation_hint G_GNUC_UNUSED,
