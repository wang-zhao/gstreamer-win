...
{
  typedef gpointer (*GMarshalFunc_POINTER__POINTER_POINTER_POINTER_POINTER) (gpointer     data1,
                                                                             gpointer     arg_1,
                                                                             gpointer     arg_2,
                                                                             gpointer     arg_3,
                                                                             gpointer     arg_4,
                                                                             gpointer     data2);
  register GMarshalFunc_POINTER__POINTER_POINTER_POINTER_POINTER callback;
  ...
  callback = (GMarshalFunc_POINTER__POINTER_POINTER_POINTER_POINTER) (marshal_data ? marshal_data : cc->callback);
