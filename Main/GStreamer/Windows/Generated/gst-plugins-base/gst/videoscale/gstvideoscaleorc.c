...
/* autogenerated from E:\Build\OSSBuild\Main\GStreamer\Windows\.\..\Source\gst-plugins-base\gst\videoscale\gstvideoscaleorc.orc */
...
#ifdef DISABLE_ORC
void
orc_merge_linear_u8 (orc_uint8 * ORC_RESTRICT d1, const orc_uint8 * ORC_RESTRICT s1, const orc_uint8 * ORC_RESTRICT s2, int p1, int n){
  int i;
...
static OrcCode *_orc_code_orc_merge_linear_u8;
void
orc_merge_linear_u8 (orc_uint8 * ORC_RESTRICT d1, const orc_uint8 * ORC_RESTRICT s1, const orc_uint8 * ORC_RESTRICT s2, int p1, int n)
{
  OrcExecutor _ex, *ex = &_ex;
  OrcCode *c = _orc_code_orc_merge_linear_u8;
...
#ifdef DISABLE_ORC
void
orc_merge_linear_u16 (orc_uint16 * ORC_RESTRICT d1, const orc_uint16 * ORC_RESTRICT s1, const orc_uint16 * ORC_RESTRICT s2, int p1, int p2, int n){
  int i;
...
static OrcCode *_orc_code_orc_merge_linear_u16;
void
orc_merge_linear_u16 (orc_uint16 * ORC_RESTRICT d1, const orc_uint16 * ORC_RESTRICT s1, const orc_uint16 * ORC_RESTRICT s2, int p1, int p2, int n)
{
  OrcExecutor _ex, *ex = &_ex;
  OrcCode *c = _orc_code_orc_merge_linear_u16;
  void (*func) (OrcExecutor *);
...
static OrcCode *_orc_code_orc_splat_u16;
void
orc_splat_u16 (orc_uint16 * ORC_RESTRICT d1, int p1, int n)
{
  OrcExecutor _ex, *ex = &_ex;
  OrcCode *c = _orc_code_orc_splat_u16;
  void (*func) (OrcExecutor *);
...
static OrcCode *_orc_code_orc_splat_u32;
void
orc_splat_u32 (orc_uint32 * ORC_RESTRICT d1, int p1, int n)
{
  OrcExecutor _ex, *ex = &_ex;
  OrcCode *c = _orc_code_orc_splat_u32;
  void (*func) (OrcExecutor *);
...
static OrcCode *_orc_code_orc_splat_u64;
void
orc_splat_u64 (orc_uint64 * ORC_RESTRICT d1, orc_int64 p1, int n)
{
  OrcExecutor _ex, *ex = &_ex;
  OrcCode *c = _orc_code_orc_splat_u64;
  void (*func) (OrcExecutor *);
...
#ifdef DISABLE_ORC
void
orc_downsample_u8 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_union16 * ORC_RESTRICT ptr4;
  orc_union16 var34;
...
static OrcCode *_orc_code_orc_downsample_u8;
void
orc_downsample_u8 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n)
{
  OrcExecutor _ex, *ex = &_ex;
  OrcCode *c = _orc_code_orc_downsample_u8;
  void (*func) (OrcExecutor *);
...
#ifdef DISABLE_ORC
void
orc_downsample_u16 (guint16 * ORC_RESTRICT d1, const guint16 * ORC_RESTRICT s1, int n){
  int i;
  orc_union16 * ORC_RESTRICT ptr0;
...
static OrcCode *_orc_code_orc_downsample_u16;
void
orc_downsample_u16 (guint16 * ORC_RESTRICT d1, const guint16 * ORC_RESTRICT s1, int n)
{
  OrcExecutor _ex, *ex = &_ex;
  OrcCode *c = _orc_code_orc_downsample_u16;
  void (*func) (OrcExecutor *);
...
#ifdef DISABLE_ORC
void
gst_videoscale_orc_downsample_u32 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
...
static OrcCode *_orc_code_gst_videoscale_orc_downsample_u32;
void
gst_videoscale_orc_downsample_u32 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n)
{
  OrcExecutor _ex, *ex = &_ex;
  OrcCode *c = _orc_code_gst_videoscale_orc_downsample_u32;
  void (*func) (OrcExecutor *);
...
#ifdef DISABLE_ORC
void
gst_videoscale_orc_downsample_yuyv (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union64 * ORC_RESTRICT ptr4;
  orc_union64 var38;
...
static OrcCode *_orc_code_gst_videoscale_orc_downsample_yuyv;
void
gst_videoscale_orc_downsample_yuyv (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n)
{
  OrcExecutor _ex, *ex = &_ex;
  OrcCode *c = _orc_code_gst_videoscale_orc_downsample_yuyv;
  void (*func) (OrcExecutor *);
...
#ifdef DISABLE_ORC
void
gst_videoscale_orc_resample_nearest_u8 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int p1, int p2, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  orc_int8 var32;
...
static OrcCode *_orc_code_gst_videoscale_orc_resample_nearest_u8;
void
gst_videoscale_orc_resample_nearest_u8 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int p1, int p2, int n)
{
  OrcExecutor _ex, *ex = &_ex;
  OrcCode *c = _orc_code_gst_videoscale_orc_resample_nearest_u8;
  void (*func) (OrcExecutor *);
...
#ifdef DISABLE_ORC
void
gst_videoscale_orc_resample_bilinear_u8 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int p1, int p2, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  orc_int8 var32;
...
static OrcCode *_orc_code_gst_videoscale_orc_resample_bilinear_u8;
void
gst_videoscale_orc_resample_bilinear_u8 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int p1, int p2, int n)
{
  OrcExecutor _ex, *ex = &_ex;
  OrcCode *c = _orc_code_gst_videoscale_orc_resample_bilinear_u8;
  void (*func) (OrcExecutor *);
...
#ifdef DISABLE_ORC
void
gst_videoscale_orc_resample_nearest_u32 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int p1, int p2, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
  orc_union32 var32;
...
static OrcCode *_orc_code_gst_videoscale_orc_resample_nearest_u32;
void
gst_videoscale_orc_resample_nearest_u32 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int p1, int p2, int n)
{
  OrcExecutor _ex, *ex = &_ex;
  OrcCode *c = _orc_code_gst_videoscale_orc_resample_nearest_u32;
  void (*func) (OrcExecutor *);
...
#ifdef DISABLE_ORC
void
gst_videoscale_orc_resample_bilinear_u32 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int p1, int p2, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  const orc_union32 * ORC_RESTRICT ptr4;
  orc_union32 var32;
...
static OrcCode *_orc_code_gst_videoscale_orc_resample_bilinear_u32;
void
gst_videoscale_orc_resample_bilinear_u32 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int p1, int p2, int n)
{
  OrcExecutor _ex, *ex = &_ex;
  OrcCode *c = _orc_code_gst_videoscale_orc_resample_bilinear_u32;
  void (*func) (OrcExecutor *);
...
#ifdef DISABLE_ORC
void
gst_videoscale_orc_resample_merge_bilinear_u32 (guint8 * ORC_RESTRICT d1, guint8 * ORC_RESTRICT d2, const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, int p1, int p2, int p3, int n){
  int i;
  orc_union32 * ORC_RESTRICT ptr0;
  ...
  for (i = 0; i < n; i++) {
    ...
    var39.x4[0] = ((orc_uint8)a.x4[0] * (256-((tmp>>8)&0xff)) + (orc_uint8)b.x4[0] * ((tmp>>8)&0xff))>>8;
    var39.x4[1] = ((orc_uint8)a.x4[1] * (256-((tmp>>8)&0xff)) + (orc_uint8)b.x4[1] * ((tmp>>8)&0xff))>>8;
    var39.x4[2] = ((orc_uint8)a.x4[2] * (256-((tmp>>8)&0xff)) + (orc_uint8)b.x4[2] * ((tmp>>8)&0xff))>>8;
    var39.x4[3] = ((orc_uint8)a.x4[3] * (256-((tmp>>8)&0xff)) + (orc_uint8)b.x4[3] * ((tmp>>8)&0xff))>>8;
    }
    /* 1: storel */
    ptr1[i] = var39;
    /* 2: loadl */
...
#else
static void
_backup_gst_videoscale_orc_resample_merge_bilinear_u32 (OrcExecutor * ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
  orc_union32 * ORC_RESTRICT ptr0;
...
static OrcCode *_orc_code_gst_videoscale_orc_resample_merge_bilinear_u32;
void
gst_videoscale_orc_resample_merge_bilinear_u32 (guint8 * ORC_RESTRICT d1, guint8 * ORC_RESTRICT d2, const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, int p1, int p2, int p3, int n)
{
  OrcExecutor _ex, *ex = &_ex;
  OrcCode *c = _orc_code_gst_videoscale_orc_resample_merge_bilinear_u32;
  void (*func) (OrcExecutor *);
...
#ifdef DISABLE_ORC
void
gst_videoscale_orc_merge_bicubic_u8 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3, const guint8 * ORC_RESTRICT s4, int p1, int p2, int p3, int p4, int n){
  int i;
  orc_int8 * ORC_RESTRICT ptr0;
  const orc_int8 * ORC_RESTRICT ptr4;
  const orc_int8 * ORC_RESTRICT ptr5;
...
static OrcCode *_orc_code_gst_videoscale_orc_merge_bicubic_u8;
void
gst_videoscale_orc_merge_bicubic_u8 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3, const guint8 * ORC_RESTRICT s4, int p1, int p2, int p3, int p4, int n)
{
  OrcExecutor _ex, *ex = &_ex;
  OrcCode *c = _orc_code_gst_videoscale_orc_merge_bicubic_u8;
  void (*func) (OrcExecutor *);
...
gst_videoscale_orc_init (void)
{
#ifndef DISABLE_ORC
  {
    ...
    _orc_code_orc_merge_linear_u8 = orc_program_take_code (p);
    orc_program_free (p);
  }
  {
    /* orc_merge_linear_u16 */
    OrcProgram *p;
      ...
      orc_program_append_2 (p, "muluwl", 0, ORC_VAR_T2, ORC_VAR_S2, ORC_VAR_P2, ORC_VAR_D1);
    ...
    _orc_code_orc_merge_linear_u16 = orc_program_take_code (p);
    orc_program_free (p);
  }
  {
    /* orc_splat_u16 */
    ...
    _orc_code_orc_splat_u16 = orc_program_take_code (p);
    orc_program_free (p);
  }
  {
    /* orc_splat_u32 */
    ...
    _orc_code_orc_splat_u32 = orc_program_take_code (p);
    orc_program_free (p);
  }
  {
    /* orc_splat_u64 */
    ...
    _orc_code_orc_splat_u64 = orc_program_take_code (p);
    orc_program_free (p);
  }
  {
    /* orc_downsample_u8 */
    ...
    _orc_code_orc_downsample_u8 = orc_program_take_code (p);
    orc_program_free (p);
  }
  {
    /* orc_downsample_u16 */
    OrcProgram *p;
      ...
      orc_program_append_2 (p, "avguw", 0, ORC_VAR_D1, ORC_VAR_T1, ORC_VAR_T2, ORC_VAR_D1);

    orc_program_compile (p);

    _orc_code_orc_downsample_u16 = orc_program_take_code (p);
    orc_program_free (p);
  }
  {
    /* gst_videoscale_orc_downsample_u32 */
    OrcProgram *p;
      ...
      orc_program_set_backup_function (p, _backup_gst_videoscale_orc_downsample_u32);
      orc_program_add_destination (p, 4, "d1");
      orc_program_add_source (p, 8, "s1");
      orc_program_add_temporary (p, 4, "t1");
      orc_program_add_temporary (p, 4, "t2");

      orc_program_append_2 (p, "splitql", 0, ORC_VAR_T1, ORC_VAR_T2, ORC_VAR_S1, ORC_VAR_D1);
      orc_program_append_2 (p, "avgub", 2, ORC_VAR_D1, ORC_VAR_T1, ORC_VAR_T2, ORC_VAR_D1);

    orc_program_compile (p);

    _orc_code_gst_videoscale_orc_downsample_u32 = orc_program_take_code (p);
    orc_program_free (p);
  }
  {
    /* gst_videoscale_orc_downsample_yuyv */
    OrcProgram *p;
      ...
      orc_program_set_backup_function (p, _backup_gst_videoscale_orc_downsample_yuyv);
      orc_program_add_destination (p, 4, "d1");
      orc_program_add_source (p, 8, "s1");
      orc_program_add_temporary (p, 4, "t1");
      orc_program_add_temporary (p, 4, "t2");
      ...
      orc_program_append_2 (p, "splitwb", 2, ORC_VAR_T1, ORC_VAR_T2, ORC_VAR_S1, ORC_VAR_D1);
      orc_program_append_2 (p, "splitwb", 1, ORC_VAR_T3, ORC_VAR_T4, ORC_VAR_T1, ORC_VAR_D1);
      ...
      orc_program_append_2 (p, "avgub", 1, ORC_VAR_T6, ORC_VAR_T3, ORC_VAR_T4, ORC_VAR_D1);
      orc_program_append_2 (p, "mergebw", 1, ORC_VAR_D1, ORC_VAR_T5, ORC_VAR_T6, ORC_VAR_D1);

    orc_program_compile (p);

    _orc_code_gst_videoscale_orc_downsample_yuyv = orc_program_take_code (p);
    orc_program_free (p);
  }
  {
    /* gst_videoscale_orc_resample_nearest_u8 */
    OrcProgram *p;
      ...
      orc_program_set_backup_function (p, _backup_gst_videoscale_orc_resample_nearest_u8);
      orc_program_add_destination (p, 1, "d1");
      orc_program_add_source (p, 1, "s1");
      orc_program_add_parameter (p, 4, "p1");
    ...
    _orc_code_gst_videoscale_orc_resample_nearest_u8 = orc_program_take_code (p);
    orc_program_free (p);
  }
  {
    /* gst_videoscale_orc_resample_bilinear_u8 */
    OrcProgram *p;
      ...
      orc_program_set_backup_function (p, _backup_gst_videoscale_orc_resample_bilinear_u8);
      orc_program_add_destination (p, 1, "d1");
      orc_program_add_source (p, 1, "s1");
      orc_program_add_parameter (p, 4, "p1");
      orc_program_add_parameter (p, 4, "p2");
    ...
    _orc_code_gst_videoscale_orc_resample_bilinear_u8 = orc_program_take_code (p);
    orc_program_free (p);
  }
  {
    /* gst_videoscale_orc_resample_nearest_u32 */
    OrcProgram *p;
      ...
      orc_program_set_backup_function (p, _backup_gst_videoscale_orc_resample_nearest_u32);
      orc_program_add_destination (p, 4, "d1");
      orc_program_add_source (p, 4, "s1");
      orc_program_add_parameter (p, 4, "p1");
      orc_program_add_parameter (p, 4, "p2");
    ...
    _orc_code_gst_videoscale_orc_resample_nearest_u32 = orc_program_take_code (p);
    orc_program_free (p);
  }
  {
    /* gst_videoscale_orc_resample_bilinear_u32 */
    OrcProgram *p;
      ...
      orc_program_set_backup_function (p, _backup_gst_videoscale_orc_resample_bilinear_u32);
      orc_program_add_destination (p, 4, "d1");
      orc_program_add_source (p, 4, "s1");
      orc_program_add_parameter (p, 4, "p1");
      orc_program_add_parameter (p, 4, "p2");
    ...
    _orc_code_gst_videoscale_orc_resample_bilinear_u32 = orc_program_take_code (p);
    orc_program_free (p);
  }
  {
    /* gst_videoscale_orc_resample_merge_bilinear_u32 */
    OrcProgram *p;
      ...
      orc_program_set_backup_function (p, _backup_gst_videoscale_orc_resample_merge_bilinear_u32);
      orc_program_add_destination (p, 4, "d1");
      ...
      orc_program_append_2 (p, "ldreslinl", 0, ORC_VAR_T2, ORC_VAR_S2, ORC_VAR_P2, ORC_VAR_P3);
      orc_program_append_2 (p, "storel", 0, ORC_VAR_D2, ORC_VAR_T2, ORC_VAR_D1, ORC_VAR_D1);
      orc_program_append_2 (p, "loadl", 0, ORC_VAR_T1, ORC_VAR_S1, ORC_VAR_D1, ORC_VAR_D1);
      orc_program_append_2 (p, "convubw", 2, ORC_VAR_T4, ORC_VAR_T1, ORC_VAR_D1, ORC_VAR_D1);
      orc_program_append_2 (p, "convubw", 2, ORC_VAR_T5, ORC_VAR_T2, ORC_VAR_D1, ORC_VAR_D1);
      ...
      orc_program_append_2 (p, "convhwb", 2, ORC_VAR_T3, ORC_VAR_T5, ORC_VAR_D1, ORC_VAR_D1);
      orc_program_append_2 (p, "addb", 2, ORC_VAR_D1, ORC_VAR_T3, ORC_VAR_T1, ORC_VAR_D1);

    orc_program_compile (p);

    _orc_code_gst_videoscale_orc_resample_merge_bilinear_u32 = orc_program_take_code (p);
    orc_program_free (p);
  }
  {
    /* gst_videoscale_orc_merge_bicubic_u8 */
    OrcProgram *p;
      ...
      orc_program_set_backup_function (p, _backup_gst_videoscale_orc_merge_bicubic_u8);
      orc_program_add_destination (p, 1, "d1");
      orc_program_add_source (p, 1, "s1");
      orc_program_add_source (p, 1, "s2");
      ...
      orc_program_append_2 (p, "mulubw", 0, ORC_VAR_T1, ORC_VAR_S2, ORC_VAR_P2, ORC_VAR_D1);
      orc_program_append_2 (p, "mulubw", 0, ORC_VAR_T2, ORC_VAR_S3, ORC_VAR_P3, ORC_VAR_D1);
      orc_program_append_2 (p, "addw", 0, ORC_VAR_T1, ORC_VAR_T1, ORC_VAR_T2, ORC_VAR_D1);
      orc_program_append_2 (p, "mulubw", 0, ORC_VAR_T2, ORC_VAR_S1, ORC_VAR_P1, ORC_VAR_D1);
      orc_program_append_2 (p, "subw", 0, ORC_VAR_T1, ORC_VAR_T1, ORC_VAR_T2, ORC_VAR_D1);
      orc_program_append_2 (p, "mulubw", 0, ORC_VAR_T2, ORC_VAR_S4, ORC_VAR_P4, ORC_VAR_D1);
      orc_program_append_2 (p, "subw", 0, ORC_VAR_T1, ORC_VAR_T1, ORC_VAR_T2, ORC_VAR_D1);
    ...
    _orc_code_gst_videoscale_orc_merge_bicubic_u8 = orc_program_take_code (p);
    orc_program_free (p);
  }
#endif
}
