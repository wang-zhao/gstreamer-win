...
/* autogenerated from E:\Build\OSSBuild\Main\GStreamer\Windows\.\..\Source\gst-plugins-base\gst\adder\gstadderorc.orc */
...
static OrcCode *_orc_code_add_int32;
void
add_int32 (gint32 * ORC_RESTRICT d1, const gint32 * ORC_RESTRICT s1, int n)
{
  OrcExecutor _ex, *ex = &_ex;
  OrcCode *c = _orc_code_add_int32;
...
static OrcCode *_orc_code_add_int16;
void
add_int16 (gint16 * ORC_RESTRICT d1, const gint16 * ORC_RESTRICT s1, int n)
{
  OrcExecutor _ex, *ex = &_ex;
  OrcCode *c = _orc_code_add_int16;
  void (*func) (OrcExecutor *);
...
static OrcCode *_orc_code_add_int8;
void
add_int8 (gint8 * ORC_RESTRICT d1, const gint8 * ORC_RESTRICT s1, int n)
{
  OrcExecutor _ex, *ex = &_ex;
  OrcCode *c = _orc_code_add_int8;
  void (*func) (OrcExecutor *);
...
static OrcCode *_orc_code_add_uint32;
void
add_uint32 (guint32 * ORC_RESTRICT d1, const guint32 * ORC_RESTRICT s1, int n)
{
  OrcExecutor _ex, *ex = &_ex;
  OrcCode *c = _orc_code_add_uint32;
  void (*func) (OrcExecutor *);
...
static OrcCode *_orc_code_add_uint16;
void
add_uint16 (guint16 * ORC_RESTRICT d1, const guint16 * ORC_RESTRICT s1, int n)
{
  OrcExecutor _ex, *ex = &_ex;
  OrcCode *c = _orc_code_add_uint16;
  void (*func) (OrcExecutor *);
...
static OrcCode *_orc_code_add_uint8;
void
add_uint8 (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int n)
{
  OrcExecutor _ex, *ex = &_ex;
  OrcCode *c = _orc_code_add_uint8;
  void (*func) (OrcExecutor *);
...
static OrcCode *_orc_code_add_float32;
void
add_float32 (float * ORC_RESTRICT d1, const float * ORC_RESTRICT s1, int n)
{
  OrcExecutor _ex, *ex = &_ex;
  OrcCode *c = _orc_code_add_float32;
  void (*func) (OrcExecutor *);
...
gst_adder_orc_init (void)
{
#ifndef DISABLE_ORC
  {
    ...
    _orc_code_add_int32 = orc_program_take_code (p);
    orc_program_free (p);
  }
  {
    /* add_int16 */
    ...
    _orc_code_add_int16 = orc_program_take_code (p);
    orc_program_free (p);
  }
  {
    /* add_int8 */
    ...
    _orc_code_add_int8 = orc_program_take_code (p);
    orc_program_free (p);
  }
  {
    /* add_uint32 */
    ...
    _orc_code_add_uint32 = orc_program_take_code (p);
    orc_program_free (p);
  }
  {
    /* add_uint16 */
    ...
    _orc_code_add_uint16 = orc_program_take_code (p);
    orc_program_free (p);
  }
  {
    /* add_uint8 */
    ...
    _orc_code_add_uint8 = orc_program_take_code (p);
    orc_program_free (p);
  }
  {
    /* add_float32 */
    ...
    _orc_code_add_float32 = orc_program_take_code (p);
    orc_program_free (p);
  }
#endif
}
